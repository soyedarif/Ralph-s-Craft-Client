...
const Instructor = ({ instructor }) => {
  ...
  return (
    <>
      <div className={`w-[21.875rem] relative mx-auto rounded-2xl overflow-hidden h-[28.125rem]`} data-aos="fade-up"
     data-aos-duration="2000" onMouseOver={() => setHover(true)} onMouseOut={() => setHover(false)}>
